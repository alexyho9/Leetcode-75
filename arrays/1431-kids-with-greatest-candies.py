...
integer extra Candies, denoting the number of extra candies that you have.
...
def kidsWithCandies(candies: list[int], extraCandies: int) -> list[bool]:
    max_before_extra = max(candies)
    return [(kid + extraCandies) >= max_before_extra for kid in candies]
